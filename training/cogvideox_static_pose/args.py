...
def _get_dataset_args(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        ...
        type=str,
        default="hand_video",
        help="The column of the dataset containing hand mesh videos. Or, the name of the file in `--data_root` folder containing the line-separated path to hand video data.",
    )
    parser.add_argument(
        "--static_video_column",
        type=str,
        default="static_video",
        help="The column of the dataset containing static scene videos. Or, the name of the file in `--data_root` folder containing the line-separated path to static video data.",
    )
    parser.add_argument(
        "--caption_column",
        type=str,
...
def _get_validation_args(parser: argparse.ArgumentParser) -> None:
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Path to a file containing validation video paths (e.g., val.txt). If provided, validation will use these videos instead of validation_prompt.",
    )
    parser.add_argument(
        "--validation_prompt",
        type=str,
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help="Maximum number of validation videos to process per validation run.",
    )
    parser.add_argument(
        "--validation_stride",
        type=int,
        default=1,
        help="Stride to use when sampling validation videos from the validation set.",
    )
    parser.add_argument(
        "--use_empty_prompts",
        action="store_true",
        help="Use empty prompts during training (useful for unconditional generation)",
    )
    parser.add_argument(
        "--guidance_scale",
        type=float,
