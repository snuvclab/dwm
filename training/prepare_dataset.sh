...
OUTPUT_DIR="/virtual_lab/jhb_vclab/taeksoo/data/world_model/lab_00/processed"
HEIGHT_BUCKETS="480"
WIDTH_BUCKETS="720"
FRAME_BUCKETS="49"
MAX_NUM_FRAMES="49"
...
CMD_WITH_PRE_ENCODING="$CMD_WITHOUT_PRE_ENCODING --save_latents_and_embeddings --save_image_latents"
