        ...
        for item in os.listdir(output_base):
            ...
            if os.path.isdir(item_path):
                if is_video_output:
                    ...
                    # For frame-based output (blender_ego_video_render.py)
                    # Handle different output modes: only-object, auto-split-clips, static, etc.
                    if script_path and 'blender_ego_video_render.py' in script_path:
                        ...
                        if video_output and auto_split_clips:
                            ...
                            if static:
                                clips_path = os.path.join(item_path, "videos_static")
                            elif only_object:
                                clips_path = os.path.join(item_path, "videos_object")
                            else:
                                clips_path = os.path.join(item_path, "videos")
                    ...
                    # Default frame-based output (blender_ego_video_render.py normal mode)
...
def main():
    ...
    for job in pending_jobs:
        ...
        if ('blender_ego_video_render.py' in args.script_path) or ('blender_ego_static.py' in args.script_path) or ('blender_ego_hand.py' in args.script_path):
