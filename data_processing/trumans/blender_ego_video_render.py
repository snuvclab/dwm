...
parser.add_argument("--only-object", action="store_true", help="Hide actor/agent and render only objects")
...
def check_frame_exists(frame_num, images_output_path, cam_params_path=None):
    """
...
def render_animation_sequence(animation_index, animation_name):
    ...
    if args.video_output:
        ...
        if direct_clips:
            ...
            if args.static:
                clips_output_path = os.path.join(anim_output_folder, "videos_static")
            elif args.only_object:
                clips_output_path = os.path.join(anim_output_folder, "videos_object")
            else:
                clips_output_path = os.path.join(anim_output_folder, "videos")
